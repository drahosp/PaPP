...
/* 
   ...
   all threads to complete, it waits for each one of the threads. All threads
   are created as joinable. Note also that we free handles when they are
   no longer needed.
*/
